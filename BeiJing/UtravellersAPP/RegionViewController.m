...
@property (nonatomic) RegionCell *oldView;
@end
...
- (void)viewDidLoad {
    ...
    self.serverDataArr = @[@"Algeria", @"Andorra", @"Angola", @"Antigua and Barbuda", @"Argentina", @"Armenia", @"Aruba", @"Australia", @"Austria"];
...
- (IBAction)saveAction:(id)sender {
    ...
    [_delegate regionCallBack:_strName];
    ...
    if (_iType) {
        ...
        UIViewController *door = [secondStoryBoard instantiateViewControllerWithIdentifier:@"NewsDetailViewController"];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    RegionCell* vv = [cell viewWithTag:123];
...
- (void)bookViewClicked:(UIButton *)button {
    ...
    RegionCell *bookView = (RegionCell *)(button.superview);
