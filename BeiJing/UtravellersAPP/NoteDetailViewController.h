...
@interface NoteDetailViewController : UIViewController<ALAutoResizingTextViewDelegate,UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout,MWPhotoBrowserDelegate>
{
    CGFloat h;
