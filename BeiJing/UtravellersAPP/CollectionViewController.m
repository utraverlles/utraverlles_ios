...
- (void)createData:(NSArray *)dataArray {
    ...
    for (int i = 0; i < [dataArray count]; i++) {
        ...
        UIViewController *v = [secondStoryBoard instantiateViewControllerWithIdentifier:@"CollectionCellView"];
        CollectionCellView *vv = (CollectionCellView *)[v.view viewWithTag:[s intValue]];
        vv.delegate = self;
