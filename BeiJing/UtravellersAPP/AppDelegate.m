...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    NSURL* storeURL = [NSPersistentStore MR_urlForStoreName:@"Model.sqlite"];
...
//    NSArray *students = [Student MR_findAll];
    ...
    NSInteger count = [Student MR_countOfEntities];
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "com.my.mac-text.UtravellersAPP" in the application's documents directory.
...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"UtravellersAPP" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"UtravellersAPP.sqlite"];
    NSError *error = nil;
